...
FRONTEND_ORIGIN = "https://b4abb128-ae9e-410b-9f7c-b6082bfb2486.preview.emergentagent.com"
...
class CORSImageTester:
    ...
    def test_cors_different_origins(self):
        ...
        test_origins = [
            "https://b4abb128-ae9e-410b-9f7c-b6082bfb2486.preview.emergentagent.com",  # Expected frontend origin
